...
I haven’t been lucky enoughd to build any Generative AI products other than playing around on my own time.
I was keen to learn from those who have built these and deployed them to customers,
so I attended the [LLMs in Production conference](https://home.mlops.community/public/events/llms-in-production-conference-2023-04-13)
...
I liked this conference as it seemed to balanced those viewpoints well, and it was pretty clear which persona the speakers fell into. 
...
Putting this in context, we still have the broad base of traditional ML that will still be required for 
...
for very targeted applications (summarise this document, what is this user's need etc.) which we'll see can be 
easily tackled by distilled versions (e.g. LLMs)

Beyond copilots, automation of these models are still being worked on, 
and the long term future is to develop agents, capably of achieving a task e.g. ”go buy me a blue couch for my living room for less than $1000"
...
He showed 4 different use-cases in domains from banking, pharma, ecommerce, and legal with accuracies of 40-60% from 
off the shelf models rising 20-30 percentage points with fine-tuning.
...
And example task from this [great panel discussion](https://home.mlops.community/public/videos/cost-optimization-and-performance)  was summarising web pages for a web search index
